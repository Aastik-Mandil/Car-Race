...
def obstacle(obs_startx,obs_starty,obs):
    ...
    if obs == 0:
        ...
        obs_pic = pygame.image.load(f"car1.jpg")
    elif obs == 2:
        obs_pic = pygame.image.load(f"car2.jpg")
    elif obs == 3:
        obs_pic = pygame.image.load(f"car4.jpg")
    elif obs == 4:
        obs_pic = pygame.image.load(f"car5.jpg")
    elif obs == 5:
        obs_pic = pygame.image.load(f"car6.jpg")
    elif obs == 6:
        obs_pic = pygame.image.load(f"car7.jpg")

    gameDisplay.blit(obs_pic,(int(obs_startx),int(obs_starty)))
...
def background():
    ...
    gameDisplay.blit(yellow_strip,(380,0))
    gameDisplay.blit(yellow_strip,(380,100))
    gameDisplay.blit(yellow_strip,(380,200))
    gameDisplay.blit(yellow_strip,(380,300))
    gameDisplay.blit(yellow_strip,(380,400))
    gameDisplay.blit(yellow_strip,(380,500))
    gameDisplay.blit(yellow_strip,(380,600))

    gameDisplay.blit(strip,(120,0))
    #gameDisplay.blit(strip,(120,200))
    #gameDisplay.blit(strip,(120,400))
    gameDisplay.blit(strip,(680,0))
    #gameDisplay.blit(strip,(680,200))
    #gameDisplay.blit(strip,(680,400))
...
def game_loop():
    ...
    while not bumped:
        ...
        # moving yello strip which is similar to background move
        if real_y < 800:
            gameDisplay.blit(backgroundpic,(0,real_y))
            gameDisplay.blit(backgroundpic,(700,real_y))
            gameDisplay.blit(yellow_strip,(400,real_y))
            gameDisplay.blit(yellow_strip,(400,real_y+100))
            gameDisplay.blit(yellow_strip,(400,real_y+200))
            gameDisplay.blit(yellow_strip,(400,real_y+300))
            gameDisplay.blit(yellow_strip,(400,real_y+400))
            gameDisplay.blit(yellow_strip,(400,real_y+500))
            gameDisplay.blit(yellow_strip,(400,real_y-100))
            gameDisplay.blit(strip,(120,real_y-200))
            gameDisplay.blit(strip,(120,real_y+20))
            gameDisplay.blit(strip,(120,real_y+30))
            gameDisplay.blit(strip,(680,real_y-100))
            gameDisplay.blit(strip,(680,real_y+20))
            gameDisplay.blit(strip,(680,real_y+30))
        ...
        if (y < obs_starty+obs_height):
            if (obs_startx+obs_width > x > obs_startx or obs_startx+obs_width > x+car_width > obs_startx):
                crash()
